...
## Default Arguments ##
default_args = { 
    'owner': 'top_full_adj_merch_lvl_cap_plng',
...
## Create DAG instance ##
dag = DAG(
    'top_full_adj_merch_lvl_cap_plng', catchup = False, default_args=default_args, schedule_interval=schedule_interval)
dag.doc_md = __doc__
...
Sensor_Store = create_sensor_task('Store','top_full_mstr_str_merch','1_4_Target_Store')
