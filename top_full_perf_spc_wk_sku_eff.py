...
dag = DAG(
    'top_full_perf_spc_wk_sku_eff', default_args=default_args,catchup = False, schedule_interval=schedule_interval)
dag.doc_md = __doc__
...
def create_bq_task(task_name):
    ...
    sql='/sql/top_full_perf_spc_wk_sku_eff/{}.sql'.format(task_name),
    params=dag_config,
    dag=dag)
...
def create_bq_to_gcs_task(task_name,source_table_name,folder,file_name):
    ...
    destination_cloud_storage_uris = "{{ var.json.ENV_Variables.Export_URI_FullLoad }}/"+folder+"/"+file_name,
    export_format = 'CSV',
    field_delimiter = ',',
    replace = True,
    print_header = False,
...
Sensor_Store_Perf = create_sensor_task('Store_Perf','top_full_mstr_str_merch','1_4_Target_Store')
Sensor_Merch_Level1 = create_sensor_task('Merch_Level1','top_full_mstr_str_merch','2_3_Merch_Level1')
Sensor_Merch_Level2 = create_sensor_task('Merch_Level2','top_full_mstr_str_merch','2_4_Merch_Level2')
Sensor_Merch_Level3 = create_sensor_task('Merch_Level3','top_full_mstr_str_merch','2_5_Merch_Level3')
Sensor_Store_Sku_Eff = create_sensor_task('Store_Sku_Eff','top_full_mstr_str_merch','1_4_Target_Store')
Sensor_Merch_Level3_Sku_Eff = create_sensor_task('Merch_Level3_Sku_Eff','top_full_mstr_str_merch','2_5_Merch_Level3')
...
Bq_to_GCS_1_Target_Perf_Weekly_Merch_Level1 = create_bq_to_gcs_task('1_GCS_Target_Perf_Weekly_Merch_Level1','Perf_Weekly_Merch_Level1','Perf_Weekly_Merch_Level1','Perf_Weekly_Merch_Level1*.csv')
Bq_to_GCS_1_Target_Perf_Weekly_Merch_Level2 = create_bq_to_gcs_task('1_GCS_Target_Perf_Weekly_Merch_Level2','Perf_Weekly_Merch_Level2','Perf_Weekly_Merch_Level2','Perf_Weekly_Merch_Level2*.csv')
Bq_to_GCS_1_Target_Perf_Weekly_Merch_Level3 = create_bq_to_gcs_task('1_GCS_Target_Perf_Weekly_Merch_Level3','Perf_Weekly_Merch_Level3','Perf_Weekly_Merch_Level3','Perf_Weekly_Merch_Level3*.csv')
...
Sensor_Store_Perf << Bq_1_9_Stage_Weekwise_Merch_Hierarchy_Performance_Final
Sensor_Store_Perf >> [Sensor_Merch_Level1,Sensor_Merch_Level2,Sensor_Merch_Level3]

Sensor_Merch_Level1 >> Bq_1_10_Target_Perf_Weekly_Merch_Level1 >> Bq_to_GCS_1_Target_Perf_Weekly_Merch_Level1
Sensor_Merch_Level2 >> Bq_1_11_Target_Perf_Weekly_Merch_Level2 >> Bq_to_GCS_1_Target_Perf_Weekly_Merch_Level2
Sensor_Merch_Level3 >> Bq_1_12_Target_Perf_Weekly_Merch_Level3 >> Bq_to_GCS_1_Target_Perf_Weekly_Merch_Level3
