/*
1.List down all the article and UOM of the respective sales_org,Store_no and Week level from the Position,Product and fixture Table for 
  types = '2 - SKU Capacity Share' from Weekwise_Merch_Hierarchy Table.
2. Aggregate the Capacity in the above query at Sales_org,Store_no,week and Spc_Product_ID level
*/

CREATE OR REPLACE TABLE  
  `{{params.project_ID}}.{{params.Optumera_Stage_DS}}.Weekwise_Merch_Hierarchy_Article_UOMs_Store_Capacity` (
...
from
  (select Week_Begin_Date, Week_End_Date, Week_Year, Week_id,Sales_Org,Store_No,POG_Key 
