/*
Join with Merch_Level3 to populate Merch_Level3_id and generate row number over PLANOGRAM_ID
*/

--Insert Record--
CREATE OR REPLACE TABLE 
	`{{params.project_ID}}.{{params.Optumera_Target_DS}}.Str_Merch_Lvl3_Planogram` ( 
	PLANOGRAM_ID INT64,
    STORE_ID INT64,
...
INNER JOIN
	...
	merch.ATTR_3 = CONCAT(Plan.Department,'|||',Plan.SubDepartment,'|||',Plan.Category)
