...
FROM
	`{{ params.GCP_WOW_ENV }}.adp_planogram_view.pog_ix_flr_floorplan_curr_v` flr INNER JOIN
	...
	`{{ params.GCP_WOW_ENV }}.adp_planogram_view.pog_ix_spc_planogram_curr_v` ver ON pog.DbFamilyKey = ver.DbFamilyKey INNER JOIN 
